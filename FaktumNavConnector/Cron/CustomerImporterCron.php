...
use Immerce\FaktumNavConnector\Importer\ImportProcessor\CustomerImportProcessor;
use Magento\Framework\Exception\FileSystemException;
use Magento\Framework\Filesystem\DirectoryList;
use Magento\Framework\Phrase;

/**
 * Customer importer cron class.
 *
 * @package Immerce\FaktumNavConnector\Cron
 * @since   1.0.0
 */
class CustomerImporterCron
{
    protected CustomerImportProcessor $importProcessor;
    private DirectoryList $directoryList;

    public function __construct(
        CustomerImportProcessor $importProcessor,
